...
WARMUP_URL = "https://www.hindustantimes.com/"
ENABLE_READ_MORE_CLICKS = False


class HindustanTimesArticleExtractor(BaseArticleExtractor):
    ...
    with PlaywrightArticleLoader(
        ...
        for index, entry in enumerate(entries, start=1):
            ...
            try:
                ...
                html_path = save_hindustan_times_html(index, entry, html)
                if html_path:
...
def save_hindustan_times_html(index: int, entry: RssEntry, html: str) -> Path | None:
